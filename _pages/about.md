...
My current work extends the same viewpoint to learned systems. Neural networks induce implicit channels through their representations, optimization paths, model outputs, distillation procedures, and probe responses. Understanding these channels is important for privacy, security, robustness, and interpretability: what information is represented, what is discarded, what is hidden, what leaks, and what can be recovered from limited observations?
